 ...
 */
public class TopBtAdatper extends BaseAdapter {
    ...
    public TopBtAdatper(LayoutInflater inflater) {
...
//        viewArrayList.add(ll4);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder = (TopBtAdatper.ViewHolder) convertView.getTag();
        }
    ...
    private void initArrayList() {
        ...
        viewText viewText2 = new viewText("蒸功夫包子铺", "(56)", "月售104单", "6元起送",
                "20分钟送达", "3200", "满15减3", "打赏金币可以抵20%",true,minflater.getContext().getResources().getDrawable(R.drawable.zhengongfu));
        viewText viewText3 = new viewText("庆丰包子铺", "(56)", "月售96单", "6元起送",
                "14分钟送达", "2700米", "满15减2", "打赏金币可以抵10%",true,minflater.getContext().getResources().getDrawable(R.drawable.qinfen));
        viewText viewText4 = new viewText("麦风包子（红谷滩新区店）", "(26)", "月售568单", "10元起送",
                "20分钟送达", "2300米", "满15减3", "打赏金币可以抵10%",true,minflater.getContext().getResources().getDrawable(R.drawable.maifen));
        viewText viewText5 = new viewText("有缘包子铺（有缘千里来相会）", "(42)", "月售86单", "6元起送",
                "22分钟送达", "3200米", "满15减2", "打赏金币可以抵10%",false,minflater.getContext().getResources().getDrawable(R.drawable.youyuan));
